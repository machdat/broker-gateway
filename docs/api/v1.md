...
**Status:** aktiv, Stand v1.11.0 (2026-04-30). Frühere Datei `docs/api/v1-draft.md` wurde im Rahmen von AP-09 K4 zu dieser Datei promotiert (reiner Rename, keine inhaltlichen Änderungen). Jede Implementierungs-Karte aktualisiert die zugehörigen Abschnitte.
