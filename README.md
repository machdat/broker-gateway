...
**Status:** Deployed mit `/v1/health` (v0.1.0), pytest-Mock-Fixture für das interne CP-Gateway (v0.2.0), Auth-Modell mit Token-Management (v0.3.0), CP-Gateway-Auth-Lifecycle inkl. `/v1/internal/health` (v0.4.0) und Instruments-Lookup mit Symbol-Cache (v0.5.0). Weitere Endpoints folgen über das KanProject `broker-gateway`.
