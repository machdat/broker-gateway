...
**Status:** v1.25.0 — Service deployed auf cma-pi-1 (Port 4000), AP-01..AP-05 + AP-10 abgeschlossen, AP-11 Phase A+B vollständig (K1..K9). WS-Lifespan-Verdrahtung (BG_QUOTES_SOURCE=ws opt-in) ist drin; Live-Smoke gegen U25235077 als nächster Schritt nach Pi-Deploy. Quote-Volume-Bugfix (IBKR-Field 7762 ÷ 10⁶) in v1.25.0. Aktueller Architektur-Stand und Komponenten-Übersicht in [`docs/02-architecture.md`](docs/02-architecture.md). Vollständige Versionshistorie in [`CHANGELOG.md`](CHANGELOG.md).
